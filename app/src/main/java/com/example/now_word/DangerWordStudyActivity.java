...
public class DangerWordStudyActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_danger_word_study);
        init();//初始化控件
    }
    ...
    public void init() {
        ...
        needstudy=wordBookDao.getHighWrongWords(needCount,highWrongtime);
    ...
    private void getNextData() {
        if (size0==0){Toast.makeText(this, "你还没有高危的单词，快去背单词吧！", Toast.LENGTH_LONG).show();
            finish();}
